...
from .models import Collection, Partners, AccountShelter, ShelterNews, LostAnimals, ShelterReport, ChatLogin, TakeAnimal, ShelterHotReport, AnimalReport
...
admin.site.register(ShelterHotReport)
